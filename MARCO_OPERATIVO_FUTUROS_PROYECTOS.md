# Marco Operativo para Futuros Proyectos

Este documento aplica solo a proyectos nuevos.
No define reglas activas para el proyecto actual Click.
...
12. Canal vivo (protocolo): [ARCHIVO_CANAL_VIVO]
13. Event log: [ARCHIVO_EVENT_LOG]
14. Heartbeat IDE_A: [ARCHIVO_HEARTBEAT_IDE_A]
15. Heartbeat IDE_B: [ARCHIVO_HEARTBEAT_IDE_B]
16. Alertas: [ARCHIVO_ALERTAS]
